...
public class ActivityQuizFive extends AppCompatActivity {
    ...
    public void radioOnclick(View view) {
        switch (view.getId()) {
            case R.id.rb_a:
                ...
                jawabQuizFive = rb_a.getText().toString();
                break;
            case R.id.rb_b:
                //Aksi ketika RadioButton dengan id rb_b di klik
                jawabQuizFive = rb_b.getText().toString();
                break;
            case R.id.rb_c:
                //Aksi ketika RadioButton dengan id rb_c di klik
                jawabQuizFive = rb_c.getText().toString();
                break;
            case R.id.rb_d:
                //Aksi ketika RadioButton dengan id rb_d di klik
                jawabQuizFive = rb_d.getText().toString();
                break;
        }
    }
    ...
    public void buttonOnclick(View view) {
        ...
        Intent intent = new Intent(ActivityQuizFive.this, ActivityResult.class);
        ...
        intent.putExtra("jawabQuizFive", jawabQuizFive);
